...
class Pacman {
  ...
  constructor(targetElement) {
    ...
    svgElement.id = "pacman";
    svgElement.setAttribute("data-frame", "1");
    ...
    useElement.setAttribute("href", this.currentSprite.href);
    svgElement.appendChild(useElement);
    targetElement.replaceWith(svgElement);
  ...
  openMouth() {
    this.currentSprite = this.sprites.chompRight;
    this.useElement.setAttribute("href", this.currentSprite.href);
  }
}
